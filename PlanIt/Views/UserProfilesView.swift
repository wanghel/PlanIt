...
//                                    if let id = self.session.profile?.id {
//                                        do {
//                                            self.friendProfile.friends.removeAll(where: {$0 == id})
//                                        }
//                                    }
//                                    self.userProfilesVM.userProfileRepository.updateProfile(self.friendProfile)
                                } else {
...
//                                    if let id = self.session.profile?.id {
//                                        do {
//                                            self.friendProfile.friends.append(id)
//                                        }
//                                    }
//                                    self.userProfilesVM.userProfileRepository.updateProfile(self.friendProfile)
                                }
...
//        UserProfilesView(profileVM: UserViewModel(profile: testUser1), friendProfileVM: UserViewModel(profile: testUser3))
    }
}
